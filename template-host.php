...
$templatePath = '/bitrix/templates/.default/components/bitrix/news.list/lk';
/*CSS*/
$this->addExternalCss("https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css");
$this->addExternalCss("$templatePath/css/chosen.min.css");
$this->addExternalCss("$templatePath/css/lk-styles.css");
/*JS*/
$this->addExternalJS("$templatePath/jquery-3.6.0.min.js");
CJSCore::Init(['masked_input']);
$this->addExternalJS("$templatePath/chosen.jquery.js");
?>
<div class="wrapper">
    <section class="lk">
        <!--header start-->
